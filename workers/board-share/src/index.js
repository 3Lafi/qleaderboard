...
const IMAGE_URL = `${APP_ORIGIN}/images/og/wisam-universal-v2.jpg`;
const BOARD_PATH = /^\/b\/([a-zA-Z0-9_-]{1,80})\/?$/;
...
function headers(contentType = 'text/html; charset=utf-8') {
    return {
        ...
        'Content-Security-Policy': `default-src 'none'; img-src ${APP_ORIGIN}; style-src 'unsafe-inline'; script-src 'self'; base-uri 'none'; frame-ancestors 'none'; form-action 'none'`,
    };
}
...
<meta property="og:image:alt" content="وسام القرآن الكريم">
...
</head><body><main>${boardId ? `<img src="${IMAGE_URL}" alt="وسام القرآن الكريم" width="1200" height="630" style="height:auto">` : ''}
